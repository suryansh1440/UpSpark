...
const TrendingStartups = () => {
  ...
  const fetchTrending = useStartupStore((s) => s.fetchTrending)
          ...
          {(items || []).map((startup) => (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <span className="rounded-full bg-indigo-500/20 px-3 py-1 text-xs text-indigo-100">{startup.isVerified ? 'Verified' : 'Trending'}</span>
              </div>
